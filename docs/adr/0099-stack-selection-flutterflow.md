# ADR-0099: Stack Selection — FLUTTERFLOW

**Date:** 2026-04-13
**Project:** Riyadh Eats (ID: test_proj_001)
**Status:** Accepted
...
The Strategist selected flutterflow based on: target platforms (['ios', 'android']), app category (food), complexity (complex), and KSA payment requirements.
