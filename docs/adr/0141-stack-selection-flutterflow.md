# ADR-0141: Stack Selection — FLUTTERFLOW

**Date:** 2026-04-13
**Project:** TestApp (ID: test_proj)
**Status:** Accepted
...
The Strategist selected flutterflow based on: target platforms (['ios', 'android']), app category (utility), complexity (simple), and KSA payment requirements.
