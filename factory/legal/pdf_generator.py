...
def _add_header_footer(canvas, doc) -> None:
    ...
    canvas.drawString(2 * cm, height - 1.7 * cm, f"{_PIPELINE_LABEL} — Legal Compliance Dossier")
...
def _title_page(app_name: str, project_id: str, styles: dict) -> list:
    ...
    elements = [
        ...
        Paragraph(
            f"Prepared by {_PIPELINE_LABEL} | Powered by Claude Opus 4.6 + Scout",
            styles["label"],
        ),
        Spacer(1, 2 * cm),
        Paragraph(
...
def _legal_disclaimer(app_name: str, styles: dict) -> list:
    return [
        ...
        Paragraph(
            ...
            f"{_PIPELINE_LABEL}, an automated software system powered by Claude Opus 4.6 "
        ...
        Paragraph(
            ...
            f"{_PIPELINE_LABEL} | Project: {app_name}",
            styles["label"],
        ),
    ]
