"""
AI Factory Pipeline v5.6 — Legal Dossier PDF Generator
...
def _build_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        author="AI Factory Pipeline v5.6",
...
def _add_header_footer(canvas, doc) -> None:
    ...
    canvas.drawString(2 * cm, height - 1.7 * cm, "AI Factory Pipeline v5.6 — Legal Compliance Dossier")
...
def _title_page(app_name: str, project_id: str, styles: dict) -> list:
    ...
    elements = [
        ...
        Paragraph(
            "Prepared by AI Factory Pipeline v5.6 | Powered by Claude Opus 4.6 + Scout",
            styles["label"],
        ),
        Spacer(1, 2 * cm),
        Paragraph(
...
def _legal_disclaimer(app_name: str, styles: dict) -> list:
    return [
        ...
        Paragraph(
            ...
            f"AI Factory Pipeline v5.6, an automated software system powered by Claude Opus 4.6 "
        ...
        Paragraph(
            ...
            f"AI Factory Pipeline v5.6 | Project: {app_name}",
            styles["label"],
        ),
    ]
