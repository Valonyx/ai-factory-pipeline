"""
AI Factory Pipeline v5.6 — Master Blueprint PDF Generator
...
def _header_footer(canvas, doc) -> None:
    ...
    canvas.drawString(2*cm, h-1.7*cm, "AI Factory Pipeline v5.6 — Master Blueprint")
...
def _title_page(app_name: str, project_id: str, blueprint_data: dict, styles: dict) -> list:
    ...
    elements = [
        ...
        Paragraph("Prepared by AI Factory Pipeline v5.6 | Claude Opus 4.6 + Scout", styles["label"]),
        Spacer(1, 0.5*cm),
        Paragraph(
